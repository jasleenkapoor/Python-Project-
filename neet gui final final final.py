...
#if simple harmonic then the variable 'choice' = 1, if finite then 'choice' = 2, and if they have input their own values for v, 'choice' will = 0 
#if they select to use their own data then they will be asked what the name of their data file is

#if they do not input their own values, the vareable 'v' will be set to 0. if the user inputs their own values for the potental, they will be saved as an array, equal to the vareable 'v' . 
